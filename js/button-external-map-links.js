    ...
    _generateNavigationLinks(lat, lng, zoom) {
        ...
        return [
            ...
            },
            {
                id: 'miniskyline',
                name: 'Mini Skyline',
                url: 'https://miniskyline.com/map',
                icon: '<div style="background: rgba(235, 235, 235, 1);">MS</div>',
                category: 'global',
                description: '3D print model building app that lets you select real Earth locations and generate printable 3D models, including city tiles with buildings and roads or terrain-focused areas for larger regions. All processing and export to 3MF happens in-browser. No permalink support found — opens to the app\'s default view rather than the current map location.',
                tags: ['3D', 'Print']
            },
            {
                id: 'forest-watch',
